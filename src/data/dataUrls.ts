 ...
 * 
 * For static site deployment, all data files are served directly from the public/ directory.
 */

/** Return the URL for a data file key.
 * Always returns the relative path since we're serving statically.
 */
 ...
 * Always false since we don't use Prophet file storage in static mode.
 */
